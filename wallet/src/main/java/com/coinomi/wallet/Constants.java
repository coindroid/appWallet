...
import com.coinomi.core.coins.TwinsMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/TWINS/TWINS/releases";

    public static final String VERSION_URL = "https://win.win//version";
    public static final String PARTNERS_URI = "https://win.win//partner.json";
    public static final String SUPPORT_EMAIL = "winwin@gmail.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(TwinsMain.get(), new ServerAddress("46.101.123.221", 1111),
                    new ServerAddress("46.101.123.221", 1111))
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.TWINS_MAIN.getCoinType(), R.drawable.twins);


        COINS_BLOCK_EXPLORERS = new HashMap<>();
        COINS_BLOCK_EXPLORERS.put(CoinID.TWINS_MAIN.getCoinType(), "https://explorer.win.win//tx/%s");
    }
